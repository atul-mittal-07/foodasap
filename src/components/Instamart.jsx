//Below is the functional collapsible accordion that we have created just by using React hooks, props drilling and lifting the states up concept

import { useState } from "react"

const Section = ({ title, desc, section, isVisible, setIsVisible }) => {
  return (
    <>
      <div className="border border-black m-5 p-5">
        ...
        {isVisible ? (<>
          ...
          <button
            ...
            className="underline">Show</button>}
      </div>
    </>
  )
}
  ...
  return (
    <>
      <Section
        ...
        setIsVisible={(section) => setVisibleSection(section)}
      />
      <Section
        key={"career"}
